...
/ Working with indices then applying at is more efficient than pushing around strings in the previous solution
...
/ We use an each ' operator here to combine the verses and days - this is effectively a zip operation
